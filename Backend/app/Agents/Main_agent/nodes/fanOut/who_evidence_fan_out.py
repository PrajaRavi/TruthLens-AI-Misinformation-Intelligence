...
def who_evidence_fan_out(state:InvestigationState) -> List[Send]|str:
    """
    ...
    if(state['category']=="HEALTH" or state['category']=="SCIENCE" ):
        return [
            Send(
                node="who_evidence_worker",  # Target node name registered in the graph
                arg={
        ...
        print("❌❌❌❌❌jumping from who_evidence_fan_out to claim_assessment")
